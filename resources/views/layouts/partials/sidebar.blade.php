    ...
    <nav class="nav">
        <div>
            ...
            <div class="nav_list">
                ...
                <a href="{{ route('notes.index') }}" class="nav_link {{ request()->routeIs('notes.index') ? 'active' : '' }}" wire:navigate>
                    <i class='bx bx-note nav_icon'></i>
                    <span class="nav_name">Mis Notas</span>
                </a>
                <a href="{{ route('chat.index') }}" class="nav_link {{ request()->routeIs('chat.index') ? 'active' : '' }}" wire:navigate>
                    <i class='bx bx-message nav_icon'></i>
                    <span class="nav_name">Chat</span>
                </a>
                <a href="{{ route('diseño.index') }}" class="nav_link {{ request()->routeIs('diseño.index') ? 'active' : '' }}" wire:navigate>
                    <i class='bx bx-layout nav_icon'></i>
                    <span class="nav_name">Diseños</span>
                </a>
